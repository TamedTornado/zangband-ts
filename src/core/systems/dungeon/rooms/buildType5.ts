/**
 * Room Type 5: Monster Nest
 *
 * A vault-like room filled with similar monsters.
 * Increases dungeon rating.
 */

import { type RoomBuilderContext } from '../DungeonTypes';

export function buildType5(ctx: RoomBuilderContext, bx0: number, by0: number): void {
